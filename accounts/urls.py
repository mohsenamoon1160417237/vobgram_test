...
from accounts.views.update_profile.check_username import CheckUsernamevalidity
...
urlpatterns = [
    ...
    path('update_profile/check_username/<str:query>/', CheckUsernamevalidity.as_view(),
