...
class AdminRejectBusinessProductStep(GenericAPIView):
    ...
    def post(self, request, prod_step_id):
        ...
        admin_accept_or_reject(False, None, admin_profile, cnt, prod_step_id, request.data['comment'])

        return Response({'status': 'rejected product step'})
