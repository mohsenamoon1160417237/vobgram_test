...
class AdminAcceptBusinessProduct(GenericAPIView):
    ...
    def post(self, request, prod_id):
        ...
        admin_accept_or_reject(True, None, admin_profile, cnt, prod_id, request.data['comment'])

        return Response({'status': 'accepted product'})
