    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experts', models.ManyToManyField(related_name='contracts', to='accounts.ExpertProfile')),
                ...
                ('service_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_contracts', to='business_service.servicerequest')),
            ],
        ),
        migrations.CreateModel(
            name='ContractFactor',
